  ...
  return (
    <div className="bg-white text-gray-800 font-sans antialiased">
      <Helmet>
        ...
        <meta
          name="description"
          content="Clínica Sanital: atenciÃ³n mÃ©dica cercana y multidisciplinar en Daimiel. Conoce a nuestro equipo y filosofía de trabajo."
        />
      </Helmet>
      ...
      <main className="container mx-auto max-w-4xl px-6 py-16 space-y-14 leading-relaxed">
        <section>
          ...
          <p className="text-lg text-gray-700">
            En Sanital creemos en una medicina cercana y basada en la
            prevención. Nuestra meta es que cada visita aporte valor real a tu
            bienestar, ya sea en
            <strong> Endocrinología</strong>, <strong>Medicina Familiar</strong>{" "}
            o <strong>Cirugía</strong>.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-lg text-gray-700">
            Ofrecemos agendas flexibles, recordatorios y canales de contacto
            directo para que tu experiencia sea cómoda. Si necesitas
            continuidad, diseñamos un plan de seguimiento adaptado a tu ritmo de
            vida.
          </p>
        </section>
      </main>
